...
**As shipped, all three are mutable pins.** The column below is the *ceiling* each mechanism can reach if you harden it, not what you get by default. Read both columns together.
