...
- 872 tests. Every fix in this range was negative-controlled **individually** — reverted alone, in a scratch copy, to confirm a specific test goes red. Batch-controlling hid two hollow tests of my own, both of which passed with their fix reverted.
