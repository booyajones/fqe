...
Tags follow semver: `fqe-v<major>.<minor>.<patch>`. To upgrade, find the new tag in github.com/booyajones/fqe, then update the `FQE_TAG="fqe-v0.1.0"` line in `.github/workflows/fqe-quality.yml`. Major versions ship a migration guide in `docs/MIGRATIONS.md`.
