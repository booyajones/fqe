...
[![tests](https://img.shields.io/badge/tests-789%20passing-brightgreen)](cli/test/) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE) [![status](https://img.shields.io/badge/status-v0.18.14-blue)](CHANGELOG.md)
...
```bash
npx --yes -p github:booyajones/fqe#fqe-v0.18.14 fqe init
